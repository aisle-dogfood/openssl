...
established. A value of zero disables the timeout. If not specified,
a default value of 30 seconds is used. (Optional)

=item B<-t> I<timeout>

Maximum time in seconds allowed for the entire operation (including connection
establishment, sending the request, and receiving the response). A value of
zero disables the timeout. If not specified, a default value of 120 seconds
is used. (Optional)
