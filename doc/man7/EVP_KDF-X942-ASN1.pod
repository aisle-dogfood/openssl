...
weak and not FIPS-approved. It is provided only for legacy compatibility.
Use AES-WRAP variants (AES-128-WRAP, AES-192-WRAP, or AES-256-WRAP) for new systems.
