...
# endif /* OPENSSL_NO_MD5 */
    ...
    /*
     * 3DES-WRAP uses SHA-1 for integrity checking (ICV), which is cryptographically
     * weak and not FIPS-approved. This algorithm is provided only for legacy
     * compatibility and should not be used in new systems. Prefer modern,
     * FIPS-approved key wrapping algorithms such as AES-KW (RFC 3394) or AES-KWP (RFC 5649).
     */
